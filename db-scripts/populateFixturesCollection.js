...
// // Get the fixtures for top 5 leagues for the past 4 years
for (let l of leagues) {
	for (let s of season) {
		const fixtures = await getLeagueSeasonFixtures(l, s);
		populateFixturesCollection(fixtures);
	}
}

// let epl2022SeasonFixtures = await getLeagueSeasonFixtures("39", "2022");
// epl2022SeasonFixtures = parseFixtureData(epl2022SeasonFixtures);
// console.log(epl2022SeasonFixtures[250].teams.home.teamID);
